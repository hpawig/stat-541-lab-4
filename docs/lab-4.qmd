...
country_w_codes <- read_csv(file = here("docs","data","country_w_codes.csv"))

regions_codes <- read_csv(file = here("docs","data",
                              "regions_codes.csv"))



# read in 2020 crosstab data
wgm20 <- read_csv(file = here("docs",
                              "data",
                              "wgm20.csv"))
...
country_region <- read_csv(file = here("docs",
                                       "data",
                              "country_region.csv"))
